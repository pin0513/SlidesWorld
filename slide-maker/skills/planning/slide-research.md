> **Cross-reference**: Original source at `~/.claude/skills/slide-research/SKILL.md`
> **Category**: Planning | **Shared standards**: [quality-standards.md](../shared/quality-standards.md)
...
1. **開放授權（優先使用）**
   - Wikimedia Commons - CC 授權，可商用
   - Wikipedia - 條目內嵌圖片

2. **權威新聞來源（世界前 20 大）**
   - 國際通訊社：Reuters, AP, AFP
   - 美國：CNN, NYT, Washington Post, USA Today
   - 英國：BBC, Guardian, Telegraph, Daily Mail
   - 其他：Al Jazeera, DW, France24, SCMP, Japan Times, ABC AU

3. **搜尋引擎（僅供參考位置）**
   - Google Image Search - 需追溯原始來源確認版權
...
| 檔案 | 來源 | 授權 | 用途建議 |
|------|------|------|----------|
| wikimedia-tai-1.jpg | Wikimedia Commons | CC BY-SA | 人物介紹頁 |
| bbc-tai-2.jpg | BBC | 新聞用途 | 比賽場景 |
```

### 圖片使用原則

1. **優先使用 CC 授權圖片**（Wikimedia Commons）
2. **新聞圖片標註來源**：「圖片來源：BBC」
3. **AI 生成圖片作為補充**：用於概念圖、示意圖、風格統一的插圖
4. **避免版權爭議**：商業用途需確認授權
