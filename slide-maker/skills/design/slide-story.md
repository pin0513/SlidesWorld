> **Cross-reference**: Original source at `~/.claude/skills/slide-story/SKILL.md`
> **Category**: Design | **Shared standards**: [quality-standards.md](../shared/quality-standards.md)
...
| 場合 | 建議風格 | 原因 |
|------|----------|------|
| **技術分享** | 理性、專業 | 聽眾重視事實和邏輯 |
| **學術報告** | 客觀、嚴謹 | 避免過度主張 |
| **產品功能介紹** | 清晰、實用 | 重點是「能做什麼」 |
| **內部培訓** | 平實、易懂 | 重點是知識傳遞 |
| **知識科普** | 吸睛但不煽情 | 可有趣但不過度情緒化 |
